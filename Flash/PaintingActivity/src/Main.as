package
{
	...
	{	private var gameTypeId:Number = 3;
		...
		private function init():void {
			...
			swatchColors = Vector.<uint>([
										  darkenColor(0x0000FF,0.7), 0x0000FF,
										  darkenColor(0x996633,0.7), 0x996633,
										  darkenColor(0x00FFFF,0.7), 0x00FFFF,
										  darkenColor(0x33CC00,0.7), 0x33CC00,
										  darkenColor(0xFF00FF,0.7), 0xFF00FF,
										  darkenColor(0xFF7F00,0.7), 0xFF7F00,
										  darkenColor(0x7F007F,0.7), 0x7F007F,
										  darkenColor(0xFF0000,0.7), 0xFF0000,
										  darkenColor(0xFFFF00,0.7), 0xFFFF00,
										  0x000000, 0x000000,
										  darkenColor(0x555555,0.7), 0x555555,
										  darkenColor(0x999999,0.7), 0x999999,
										  darkenColor(0xFFFFFF,0.9), 0xFFFFFF
										  ]);
			...
			*/
			...
			controlPanel.graphics.drawRect(0, 0, boardWidth, 80);
			...
			btnErase.x =  1900 /*1260*/;
			/*
			btnErase.y = controlPanel.height/2;
			btnErase.width = btnErase.width*2;
			btnErase.height = btnErase.height*2;
			...
			btnUndo.width = btnUndo.width*2;
			btnUndo.height = btnUndo.height*2;
