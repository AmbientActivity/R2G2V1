...
INSERT INTO PublicMediaFiles (ResponseTypeId, MediaPathTypeId, StreamId)
SELECT 2, 8, StreamId FROM MediaFiles WHERE [Path] = @pathSharedLibrary + 'activities\matching-game\sounds\' AND [FileType] = 'mp3'

--- Activity 3 - ResponseType "Cats" ---
INSERT INTO PublicMediaFiles (ResponseTypeId, MediaPathTypeId, StreamId)
SELECT 3, 10, StreamId FROM MediaFiles WHERE [Path] = @pathSharedLibrary + 'videos\cats\' AND [FileType] = 'mp4'

--- Activity 5 - ResponseType "Radio" ---
INSERT INTO PublicMediaFiles (ResponseTypeId, MediaPathTypeId, StreamId)
SELECT 5, 1, StreamId FROM MediaFiles WHERE [Path] = @pathSharedLibrary + 'audio\music\' AND [FileType] = 'mp3'

INSERT INTO PublicMediaFiles (ResponseTypeId, MediaPathTypeId, StreamId)
SELECT 5, 2, StreamId FROM MediaFiles WHERE [Path] = @pathSharedLibrary + 'audio\radio-shows\' AND [FileType] = 'mp3'

--- Activity 6 - ResponseType "Television" ---
INSERT INTO PublicMediaFiles (ResponseTypeId, MediaPathTypeId, StreamId)
SELECT 6, 5, StreamId FROM MediaFiles WHERE [Path] = @pathSharedLibrary + 'videos\tv-shows\'

--- Activity 7 - ResponseType "Ambient" ---
INSERT INTO PublicMediaFiles (ResponseTypeId, MediaPathTypeId, StreamId)
SELECT 8, 9, StreamId FROM MediaFiles WHERE [Path] = @pathSharedLibrary + 'videos\ambient\' AND [FileType] = 'mp4'
